...
export const Welcome: React.FC = () => {
  const { t } = useTranslation('translation', { keyPrefix: 'wiki.welcome' })
  ...
  return (
    <Flex justify="center" align="flex-start" w="100%" h="100%">
      ...
      >
        ...
        <Text>
          {t('welcomeDescriptionOne')} <Link color={colors.orange} href="https://rookgaard.live">Rookgaard Independence</Link>.
        </Text>
        <Text mt="10px">
          {t('welcomeDescriptionTwo')}
        </Text>
        <Text mt="10px">
          {t('welcomeDescriptionThree')}
        </Text>
        <Text mt="10px">
          {t('welcomeDescriptionFour')}
          <Link color={colors.orange} href={"https://discord.com/invite/AeEFxZje5J"}>
            {' '}Discord
          </Link>.
        </Text>
